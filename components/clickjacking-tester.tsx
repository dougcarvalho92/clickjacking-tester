    ...
    <>
      <main className="screen-content">
        ...
        <section className="notice">
          ...
          tentam incorporar a URL informada. Se o servidor retornar{" "}
          <code>X-Frame-Options: DENY/SAMEORIGIN</code> ou CSP{" "}
          <code>frame-ancestors</code>, o carregamento poderá ser bloqueado pelo
          browser. A detecção por iframe é uma indicação prática e não substitui
          a inspeção dos headers HTTP.
        </section>
